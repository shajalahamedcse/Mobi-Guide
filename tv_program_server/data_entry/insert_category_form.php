...
<title>Insert Category Info</title>
...
<form name="insertCategoryForm" method="post" enctype="multipart/form-data" action="sql_insert_category.php">

<label>Category Name:</label>
<input type="text" name="categoryName" onblur="this.value=myTrim(this.value);" required/>
